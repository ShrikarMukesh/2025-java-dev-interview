...
import codesnippet.dto.Employee;
import codesnippet.dto.SalaryRange;
...
public class SalaryRangeGrouping {
    public static void main(String[] args) {
        ...
        Map<SalaryRange, List<Employee>> salaryRangeListMap = employees.stream()
                .collect(Collectors.groupingBy(
                        e -> getSalaryRange(e)));
        System.out.println(salaryRangeListMap);
    }
